...
require.config({
  ...
  //injector:mainReleasePaths
  {
    ...
    'jquery': 'web/js/libs/jquery/jquery-3.1.1',
    ...
    'ojs': 'web/js/libs/oj/v4.1.0/debug',
    'ojL10n': 'web/js/libs/oj/v4.1.0/ojL10n',
    'ojtranslations': 'web/js/libs/oj/v4.1.0/resources',
    ...
    'cmn-cca': 'test/mocks',
    'cmn-util': 'web/common/js/util',

    // 'mockjax': 'mockjax/jquery.mockjax',
    // 'customElements': 'web/js/libs/webcomponents/custom-elements.min',
	// 'knockout-mapping': 'web/js/libs/knockout/knockout.mapping-latest.debug'
  },
